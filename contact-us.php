...
<title>KING MOTORS RENTAL CARS|| Contact Us Page</title>
<!--Bootstrap -->
...
{ ?>
          <ul>
            ...
            <li>
              ...
              <div class="contact_info_m"><a href="https://mail.google.com/mail/u/2/#inbox?compose=new"><?php   echo htmlentities($result->EmailId); ?></a></div>
            </li>
            <li>
              <div class="icon_wrap"><i class="fa fa-phone" aria-hidden="true"></i></div>
              <div class="contact_info_m"><a href="tel: +254 796 588 059"><?php   echo htmlentities($result->ContactNo); ?></a></div>
            </li>
          </ul>
        <?php }} ?>
        </div>
