...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Prepare the SQL query with filter criteria
    $sql = "SELECT tblvehicles.*, tblbrands.BrandName, tblbrands.id as bid  
            FROM tblvehicles 
            JOIN tblbrands ON tblbrands.id = tblvehicles.VehiclesBrand 
            WHERE tblvehicles.VehiclesBrand = :brandId AND tblvehicles.FuelType = :fuelType";
    ...
    // If the form is not submitted, show all car listings without any filters
    $sql = "SELECT tblvehicles.*, tblbrands.BrandName, tblbrands.id as bid  
            FROM tblvehicles 
            JOIN tblbrands ON tblbrands.id = tblvehicles.VehiclesBrand";
...
<html lang="en">
<head>
    <title>KING MOTORS RENTAL CARS | Car Listing</title>
<!--Bootstrap -->
